...
const { readOnePizza } = require('../../../tutorials/pizzeria/api/fat-model/models/pizza');
const { readAllPizza, addOneDFilm, deleteOnePizza,updateOneFilm } = require('../models/film');
...
router.get('/:id', (req, res) => {
  const film=readOnePizza(req.params.id)
